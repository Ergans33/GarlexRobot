...
from gaclex import MONGO_DB_URI
from gaclex import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import gaclex.events

        path = Path(f"gaclex/modules/{shortname}.py")
        name = "gaclex.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["gaclex.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "gaclex/modules/*.py"
