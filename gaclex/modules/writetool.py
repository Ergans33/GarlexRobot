...
`◇───────────────◇`
💔 **ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ** : [GACLEX](https://t.me/gaclexa)
😇 **ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ ​** : {}
💕 **ᴘᴏᴡᴇʀᴇᴅ ʙʏ​ **  : GACLEX
`◇───────────────◇️  `
    """
JOIN_ASAP = f" **🚫 Akses Ditolak**\n\n silahkan bergabung [Gaclex](https://t.me/gaclexxa) dan [Gaclex](https://t.me/gaclexx). silahkan bergabung lalu coba lagi." 
FSUBB = InlineKeyboardMarkup( 
           [[ 
               InlineKeyboardButton(text="Gaclex", url=f"https://t.me/gaclexxa"),
               InlineKeyboardButton(text="Gaclex", url=f"https://t.me/gaclexx")
           ]]
)
