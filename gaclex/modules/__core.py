...
from gaclex import OWNER_ID
from gaclex import TEMP_DOWNLOAD_DIRECTORY as path
from gaclex import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './gaclex/resources/iraa.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./gaclex/modules/{}.py".format(input_str)
...
from gaclex.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "gaclex/modules/",  # pylint:disable=E0602
                )
            )
...
from gaclex import telethn as tbot, OWNER_ID, DEV_USERS
from gaclex.events import register
import os
import asyncio
import os
...
from pathlib import Path
from gaclex import telethn as borg
