...
if ENV:
    ...
    from gaclex.config import Development as Config
...
pbot = Client("gaclex", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
GACLEX = list(GACLEX) + list(DEV_USERS)
...
from gaclex.modules.helper_funcs.handlers import (
